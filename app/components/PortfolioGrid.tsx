...
type Project = {
  ...
  details: string[]
  github: string
  /** Live deployment (Vercel, etc). The card shows a "Live Demo" link only when this is set. */
  liveUrl?: string
...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    /* layout="position": the card repositions on filter changes but its size
       snaps, so expanding the panel below can't scale-distort the card's text. */
    <motion.article
      layout="position"
          ...
          {project.details.length > 0 && (
            <>
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-sm text-sm font-medium text-primary transition-colors hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-card"
              >
              ...
              <motion.div
                ...
                // Collapsed text stays in the DOM for search engines; hide it from
                // screen readers so they agree with aria-expanded.
                aria-hidden={!expanded}
                className="overflow-hidden"
              >
                <ul className="list-disc list-outside space-y-2 pl-5 pt-4 text-sm text-muted-foreground">
          ...
          <div className="flex justify-between items-center gap-4 pt-4">
            {project.liveUrl && (
              <a
                ...
                aria-label={`Open the live ${project.title} app in a new tab`}
            ...
            {project.github && (
              <a
                ...
                className="ml-auto text-muted-foreground hover:text-primary transition-colors rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-card"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-fade-up text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A showcase of my projects, demonstrating my skills in web development, machine learning, and data visualization. Each project highlights my ability to solve complex problems and deliver effective solutions.
          </p>
        </div>
